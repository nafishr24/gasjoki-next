  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      <div
        ...
        onClick={onClose}
      ></div>
      <div className={`bg-slate-900 border border-slate-700 w-full max-w-md rounded-2xl shadow-2xl relative transition-all duration-300 transform ${isAnimating ? "opacity-100 scale-100 translate-y-0" : "opacity-0 scale-95 translate-y-4"}`}>
        <Button
          variant="close"
          onClick={onClose}
